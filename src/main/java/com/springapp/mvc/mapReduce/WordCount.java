...
public class WordCount {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String[] arr = new String[]{WordCount.class.getResource("/") + "data/nietzsche-chapter-1.txt", "/user/gutenberg/output"};
        String[] otherArgs = new GenericOptionsParser(configuration, arr).getRemainingArgs();
